...
const FolderSelect = ({setdownloadModal}) => {
    ...
    return (
    <div className='fixed  bg-black  transition ease-in-out delay-300 row-full insect-0 bg-opacity-50 backdrop-blur-sm flex justify-center items-center'>
    <div className='w-1/2 h-2/6 transition ease-in-out delay-100 radius relative bg-black  borderTrans flex justify-center items-center rounded-2xl '>
