...
const Upload = ({setmodal,setfile}) => {
  ...
  return (
    <div onClick={()=>{setoutside(true)}} className='fixed min-h-screen bg-black  transition ease-in-out delay-300 -mt-0 sm:-mt-5  row-full inset-0 bg-opacity-50 backdrop-blur-sm flex justify-center items-center'>
        <div className='sm:flex hidden w-1/6'>
        </div>
        {folderModal ? 
        <div onClick={()=>{setisClicked(true)}} className='sm:w-1/2 w-[90%] h-1/2 sm:h-2/6  transition ease-in-out delay-100 radius relative bg-black    border-white border border-dashed flex justify-center items-center rounded-3xl '>
            <button onClick={goBack} className='absolute text-lg sm:text-xl p-2 sm:p-4 top-4 left-4'>&larr; Back</button>
            <button onClick={exitModal} className='absolute p-1 sm:p-2 top-4 right-4'>
            ...
            { FileModal ? 
                <p className='text-2xl sm:text-3xl absolute top-4 py-8'>Choose File</p>
            :
                <p className='text-2xl sm:text-3xl absolute top-4 py-8'>Choose Folder</p>
            }
        ...
        :
        <div onClick={()=>{setisClicked(true)}} className='sm:w-1/2 w-[90%] h-1/2 sm:h-2/6 radius relative bg-black  border-white border border-dashed  flex justify-center items-center rounded-3xl '>
