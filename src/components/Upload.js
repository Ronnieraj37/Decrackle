...
const Upload = ({setmodal,setfile}) => {
  ...
  return (
    <div onClick={()=>{setoutside(true)}} className='fixed  bg-black  transition ease-in-out delay-300 -mt-5  row-full insect-0 bg-opacity-50 backdrop-blur-sm flex justify-center items-center'>
        ...
        {folderModal ? 
            <div onClick={()=>{setisClicked(true)}} className='w-1/2 h-2/6 transition ease-in-out delay-100 radius relative bg-black    borderDash flex justify-center items-center rounded-2xl '>
            <button onClick={()=>{setfolderModal(!folderModal)}} className='absolute underline p-4 top-4 left-4'>Skip</button>
        ...
        :
        <div onClick={()=>{setisClicked(true)}} className='w-1/2 h-2/6 radius relative bg-black    borderDash flex justify-center items-center rounded-2xl '>
