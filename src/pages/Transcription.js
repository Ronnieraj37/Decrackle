...
const Transcription = ({setselected,file,setfile}) => {
    const navigate = useNavigate();
    const [playing, setplaying] = useState(false);
    const [transcipted, settranscipted] = useState(false);
  ...
  return (
    <div className='flex flex-col overflow-auto h-[90%] w-full items-center justify-center'>
        ...
        <div className='w-full h-full  items-center justify-center  flex'>
            {
                ...
                <div className='h-full w-full md:scale-100 scale-90 flex items-center justify-around  rounded-2xl '>
                    ...
                    <p className='mx-2 text-2xl font-light'>Transcription File</p>
                    {playing ? 
                    ...
                    <button onClick={()=>{}} className='my-1 font-light underline-offset-2 underline '>Give Feedback</button>
                    </div>
                    </div>
                </div>
                </div>
        ...
        <div className='h-full w-full flex items-center justify-around  rounded-2xl '>
            ...
            <button onClick={()=>{setfile(null);navigate("/")}} className='my-1 font-light underline-offset-2 underline '>Replace</button>
            </div>
            <div className='flex items-center'>
            <BsDot size={25}/>
