...
const Support = () => {
  ...
  return (
    ...
    <div className='w-4/5  h-2/3 relative border-white border-[1px] border-dashed  flex-col justify-center items-center rounded-2xl '>
          ...
          <div className='flex w-5/6 sm:w-4/6 items-center justify-around'>
